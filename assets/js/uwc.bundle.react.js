...
// src/textarea/react.ts
var UwcTextarea2 = createComponent2({
...
// src/virtualscroller/react.ts
var UwcVirtualScroller2 = createComponent3({
...
// src/stepper/react.ts
var UwcStepperReact = createComponent4({
  react: React4,
  tagName: "uwc-stepper",
...
var UwcStepperPanelReact = createComponent4({
  react: React4,
...
// src/panel/react.ts
var UwcPanelReact = createComponent5({
  react: React5,
  tagName: "uwc-panel",
...
// src/message/react.ts
var UwcMessageReact = createComponent6({
  react: React6,
  tagName: "uwc-message",
...
// src/toast/react.ts
var UwcToastReact = createComponent7({
  react: React7,
  tagName: "uwc-toast",
...
// src/button/react.ts
var UwcButton2 = createComponent8({
  tagName: "uwc-button",
...
// src/card/react.ts
var UwcCardReact = createComponent9({
  react: React9,
  tagName: "uwc-card",
  elementClass: UwcCard
});
...
// src/dialog/react.ts
var UwcDialog2 = createComponent10({
  tagName: "uwc-dialog",
  elementClass: UwcDialog,
  react: React10,
  events: {
    onUwcShow: "uwc-show",
    onUwcHide: "uwc-hide",
    onUwcMaximize: "uwc-maximize",
    onUwcUnmaximize: "uwc-unmaximize",
    onUwcDragStart: "uwc-drag-start",
    onUwcDragEnd: "uwc-drag-end",
...
UwcCheckbox.styles = [styles_default10];
__decorateClass([
  n4({ type: Boolean, reflect: true })
...
// src/checkbox/react.ts
var UwcCheckbox2 = createComponent11({
...
UwcColorPicker.styles = [styles_default11];
__decorateClass([
  n4({ reflect: true })
...
// src/colorpicker/react.ts
var UwcColorPicker2 = createComponent12({
...
// ── Styles ────────────────────────────────────────────────────────────────
UwcDatatable.styles = [styles_default12];
__decorateClass([
  n4({ attribute: false })
...
// src/datatable/react.ts
var UwcDatatable2 = createComponent13({
...
// STYLES
// ═══════════════════════════════════════════════════════════════════════════
UwcDatepicker.styles = [styles_default13];
__decorateClass([
  n4({ attribute: false })
...
// src/datepicker/react.ts
var UwcDatepicker2 = createComponent14({
...
UwcDropdown.styles = [styles_default14];
__decorateClass([
  n4({ type: Array })
...
// src/dropdown/react.ts
var UwcDropdown2 = createComponent15({
...
// src/icon/react.ts
var UwcIcon2 = createComponent16({
  tagName: "uwc-icon",
...
UwcInputText.styles = [styles_default15];
__decorateClass([
  n4()
...
// src/inputtext/react.ts
var UwcInputText2 = createComponent17({
...
import { createComponent as createComponent18 } from "@lit/react";
...
UwcListbox.styles = [styles_default16];
__decorateClass([
  n4({ type: Array })
...
// src/listbox/react.ts
var UwcListbox2 = createComponent18({
  tagName: "uwc-listbox",
...
UwcMenu.styles = [styles_default17];
__decorateClass([
  n4({ type: String, attribute: "trigger-id" })
...
// src/menu/react.ts
var UwcMenu2 = createComponent19({
  tagName: "uwc-menu",
...
import { createComponent as createComponent20 } from "@lit/react";
...
UwcOverlay.styles = [styles_default18];
__decorateClass([
  n4({ type: String, attribute: "trigger-id" })
...
// src/overlay/react.ts
var UwcOverlay2 = createComponent20({
  tagName: "uwc-overlay",
...
import { createComponent as createComponent21 } from "@lit/react";
...
UwcPaginator.styles = styles_default19;
__decorateClass([
  n4({ type: Number, reflect: true })
...
// src/paginator/react.ts
var UwcPaginator2 = createComponent21({
...
import { createComponent as createComponent22 } from "@lit/react";
...
UwcPopover.styles = [styles_default20];
__decorateClass([
  n4({ type: String, attribute: "trigger-id" })
...
// src/popover/react.ts
var UwcPopover2 = createComponent22({
  tagName: "uwc-popover",
...
import { createComponent as createComponent23 } from "@lit/react";
...
UwcRadioButton.styles = [styles_default21];
__decorateClass([
  n4({ type: Boolean, reflect: true })
...
// src/radiobutton/react.ts
var UwcRadioButton2 = createComponent23({
...
import { createComponent as createComponent24 } from "@lit/react";
...
UwcToggleButton.styles = [styles_default22];
__decorateClass([
  n4({ type: Boolean, reflect: true })
...
// src/togglebutton/react.ts
var UwcToggleButton2 = createComponent24({
...
import { createComponent as createComponent25 } from "@lit/react";
...
UwcToggleSwitch.styles = [styles_default23];
__decorateClass([
  n4({ type: Boolean, reflect: true })
...
// src/toggleswitch/react.ts
var UwcToggleSwitch2 = createComponent25({
...
import { createComponent as createComponent26 } from "@lit/react";
...
UwcTooltip.styles = [styles_default24];
__decorateClass([
  n4({ type: String })
...
// src/tooltip/react.ts
var UwcTooltip2 = createComponent26({
  tagName: "uwc-tooltip",
...
import { createComponent as createComponent27 } from "@lit/react";
...
// src/tabs/react.ts
var UwcTabs2 = createComponent27({
  tagName: "uwc-tabs",
...
var UwcTabPanel2 = createComponent27({
...
// src/accordion/react.ts
import React28 from "react";
import { createComponent as createComponent28 } from "@lit/react";
...
// src/accordion/react.ts
var UwcAccordionReact = createComponent28({
  react: React28,
  tagName: "uwc-accordion",
  elementClass: UwcAccordion,
  events: {
    onUwcOpen: "uwc-open",
    onUwcClose: "uwc-close",
    onUwcChange: "uwc-change"
...
var UwcAccordionPanelReact = createComponent28({
  react: React28,
  tagName: "uwc-accordion-panel",
  elementClass: UwcAccordionPanel,
  events: {
    onUwcOpen: "uwc-open",
    onUwcClose: "uwc-close"
  }
...
// src/carousel/react.ts
import React29 from "react";
import { createComponent as createComponent29 } from "@lit/react";
...
UwcCarousel.styles = styles_default25;
__decorateClass([
  n4({ type: Array })
...
// src/carousel/react.ts
var UwcCarouselReact = createComponent29({
  react: React29,
  tagName: "uwc-carousel",
  elementClass: UwcCarousel,
  events: {
    onUwcPage: "uwc-page",
    onUwcAutoplay: "uwc-autoplay"
  }
});

// src/galleria/react.ts
import React30 from "react";
import { createComponent as createComponent30 } from "@lit/react";
...
UwcGalleria.styles = styles_default26;
__decorateClass([
  n4({ type: Array })
...
// src/galleria/react.ts
var UwcGalleriaReact = createComponent30({
  react: React30,
...
import { createComponent as createComponent31 } from "@lit/react";
...
// src/splitter/react.ts
var UwcSplitterReact = createComponent31({
  react: React31,
...
var UwcSplitterPanelReact = createComponent31({
  react: React31,
...
export {
  UwcAccordionReact as UwcAccordion,
  UwcAccordionPanelReact as UwcAccordionPanel,
  UwcButton2 as UwcButton,
  UwcCardReact as UwcCard,
  UwcCarouselReact as UwcCarousel,
  UwcCheckbox2 as UwcCheckbox,
  UwcColorPicker2 as UwcColorPicker,
  UwcDatatable2 as UwcDatatable,
  UwcDatepicker2 as UwcDatepicker,
  UwcDialog2 as UwcDialog,
