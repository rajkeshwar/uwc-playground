...
var UwcDialog = class extends i4 {
  ...
  _doClose() {
    ...
    const onAnimEnd = (e8) => {
      if (e8.animationName === "uwc-dlg-out") finish();
    };
  ...
  _onDialogClick(e8) {
    ...
    if (e8.target === this._dialog) this.hide();
  }
  _onMaximize() {
...
UwcDialog.styles = [styles_default];
__decorateClass([
...
// src/dialog/react.ts
var UwcDialog2 = createComponent({
  tagName: "uwc-dialog",
