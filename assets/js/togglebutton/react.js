...
var i = (t3, ...e5) => {
  const o7 = 1 === t3.length ? t3[0] : e5.reduce((e6, s4, o8) => e6 + ((t4) => {
    if (true === t4._$cssResult$) return t4.cssText;
    if ("number" == typeof t4) return t4;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + t4 + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(s4) + t3[o8 + 1], t3[0]);
  return new n(o7, t3, s);
};
var S = (s4, o7) => {
  if (e) s4.adoptedStyleSheets = o7.map((t3) => t3 instanceof CSSStyleSheet ? t3 : t3.styleSheet);
...
function M(t3, i5, s4 = t3, e5) {
  ...
  return h3?.constructor !== o7 && (h3?._$AO?.(false), void 0 === o7 ? h3 = void 0 : (h3 = new o7(t3), h3._$AT(t3, s4, e5)), void 0 !== e5 ? (s4._$Co ?? (s4._$Co = []))[e5] = h3 : s4._$Cl = h3), void 0 !== h3 && (i5 = M(t3, h3._$AS(t3, i5.values), h3, e5)), i5;
}
var R = class {
  constructor(t3, i5) {
...
var H = class {
  ...
  _$AI(t3, i5 = this, s4, e5) {
    ...
    let o7 = false;
    if (void 0 === h3) t3 = M(this, t3, i5, 0), o7 = !a2(t3) || t3 !== this._$AH && t3 !== E, o7 && (this._$AH = t3);
    else {
      const e6 = t3;
      let n5, r5;
      for (t3 = h3[0], n5 = 0; n5 < h3.length - 1; n5++) r5 = M(this, e6[s4 + n5], i5, n5), r5 === E && (r5 = this._$AH[n5]), o7 || (o7 = !a2(r5) || r5 !== this._$AH[n5]), r5 === A ? t3 = A : t3 !== A && (t3 += (r5 ?? "") + h3[n5 + 1]), this._$AH[n5] = r5;
    }
    o7 && !e5 && this.j(t3);
  }
  j(t3) {
...
var r4 = (t3 = o5, e5, r5) => {
  ...
  if (void 0 === s4 && globalThis.litPropertyMetadata.set(i5, s4 = /* @__PURE__ */ new Map()), "setter" === n5 && ((t3 = Object.create(t3)).wrapped = true), s4.set(r5.name, t3), "accessor" === n5) {
    ...
    return { set(r6) {
      ...
      e5.set.call(this, r6), this.requestUpdate(o7, n6, t3, true, r6);
    }, init(e6) {
      return void 0 !== e6 && this.C(o7, void 0, t3, e6), e6;
    } };
  }
  if ("setter" === n5) {
    const { name: o7 } = r5;
    return function(r6) {
      const n6 = this[o7];
      e5.call(this, r6), this.requestUpdate(o7, n6, t3, true, r6);
    };
  }
  throw Error("Unsupported decorator location: " + n5);
};
function n4(t3) {
  return (e5, o7) => "object" == typeof o7 ? r4(t3, e5, o7) : ((t4, e6, o8) => {
    const r5 = e6.hasOwnProperty(o8);
    return e6.constructor.createProperty(o8, t4), r5 ? Object.getOwnPropertyDescriptor(e6, o8) : void 0;
  })(t3, e5, o7);
}
...
var UwcToggleButton = class extends i4 {
  ...
  _onChange(e5) {
    ...
    this._spawnRipple(e5);
    this.dispatchEvent(new CustomEvent("uwc-change", {
      bubbles: true,
      composed: true,
      detail: { checked: this.checked, originalEvent: e5 }
    }));
  }
  _spawnRipple(e5) {
    ...
    const x2 = (e5.clientX || rect.left + rect.width / 2) - rect.left - size / 2;
    const y3 = (e5.clientY || rect.top + rect.height / 2) - rect.top - size / 2;
...
UwcToggleButton.styles = [styles_default];
__decorateClass([
...
// src/togglebutton/react.ts
var UwcToggleButton2 = createComponent({
