...
var y = class extends HTMLElement {
  ...
  requestUpdate(t6, s5, i7, e7 = false, h4) {
    if (void 0 !== t6) {
      ...
      if (false === e7 && (h4 = this[t6]), i7 ?? (i7 = r7.getPropertyOptions(t6)), !((i7.hasChanged ?? f)(h4, s5) || i7.useDefault && i7.reflect && h4 === this._$Ej?.get(t6) && !this.hasAttribute(r7._$Eu(t6, i7)))) return;
      this.C(t6, s5, i7);
    }
    false === this.isUpdatePending && (this._$ES = this._$EP());
  }
  C(t6, s5, { useDefault: i7, reflect: e7, wrapped: h4 }, r7) {
    i7 && !(this._$Ej ?? (this._$Ej = /* @__PURE__ */ new Map())).has(t6) && (this._$Ej.set(t6, r7 ?? s5 ?? this[t6]), true !== h4 || void 0 !== r7) || (this._$AL.has(t6) || (this.hasUpdated || i7 || (s5 = void 0), this._$AL.set(t6, s5)), true === e7 && this._$Em !== t6 && (this._$Eq ?? (this._$Eq = /* @__PURE__ */ new Set())).add(t6));
  }
  async _$EP() {
...
var N = (t6, i7) => {
  ...
  return [V(t6, l4 + (t6[s5] || "<?>") + (2 === i7 ? "</svg>" : 3 === i7 ? "</math>" : "")), e7];
};
var S2 = class _S {
    ...
    for (; null !== (r7 = P.nextNode()) && d3.length < u5; ) {
      if (1 === r7.nodeType) {
        if (r7.hasAttributes()) for (const t7 of r7.getAttributeNames()) if (t7.endsWith(h2)) {
          const i8 = v3[a3++], s5 = r7.getAttribute(t7).split(o3), e8 = /([.?@])?(.*)/.exec(i8);
          d3.push({ type: 1, index: l4, name: e8[2], strings: s5, ctor: "." === e8[1] ? I : "?" === e8[1] ? L : "@" === e8[1] ? z : H }), r7.removeAttribute(t7);
...
var H = class {
  ...
  _$AI(t6, i7 = this, s5, e7) {
    ...
    if (void 0 === h4) t6 = M(this, t6, i7, 0), o6 = !a2(t6) || t6 !== this._$AH && t6 !== E, o6 && (this._$AH = t6);
      ...
      const e8 = t6;
      let n5, r7;
      for (t6 = h4[0], n5 = 0; n5 < h4.length - 1; n5++) r7 = M(this, e8[s5 + n5], i7, n5), r7 === E && (r7 = this._$AH[n5]), o6 || (o6 = !a2(r7) || r7 !== this._$AH[n5]), r7 === A ? t6 = A : t6 !== A && (t6 += (r7 ?? "") + h4[n5 + 1]), this._$AH[n5] = r7;
    }
    o6 && !e7 && this.j(t6);
  }
  j(t6) {
...
var e4 = (t6) => (...e7) => ({ _$litDirective$: t6, values: e7 });
var i5 = class {
  constructor(t6) {
  }
  get _$AU() {
...
var u4 = (e7, s5, t6) => {
  ...
  for (let l4 = s5; l4 <= t6; l4++) r7.set(e7[l4], l4);
  return r7;
};
var c4 = e4(class extends i5 {
  ...
  dt(e7, s5, t6) {
    ...
    const l4 = [], o6 = [];
    let i7 = 0;
    for (const s6 of e7) l4[i7] = r7 ? r7(s6, i7) : i7, o6[i7] = t6(s6, i7), i7++;
...
var l3 = e4(class extends i5 {
  ...
  update(i7, [t6]) {
    ...
    } else if (i7.type === t3.ATTRIBUTE && o6.getAttribute(l4) === t6 + "") return E;
    return p3(i7), t6;
  }
});
...
var r5 = (t6 = o5, e7, r7) => {
  ...
  if (void 0 === s5 && globalThis.litPropertyMetadata.set(i7, s5 = /* @__PURE__ */ new Map()), "setter" === n5 && ((t6 = Object.create(t6)).wrapped = true), s5.set(r7.name, t6), "accessor" === n5) {
    ...
    return { set(r8) {
      ...
      e7.set.call(this, r8), this.requestUpdate(o6, n6, t6, true, r8);
    }, init(e8) {
  ...
  if ("setter" === n5) {
    ...
    return function(r8) {
      const n6 = this[o6];
      e7.call(this, r8), this.requestUpdate(o6, n6, t6, true, r8);
    };
  }
  throw Error("Unsupported decorator location: " + n5);
};
function n4(t6) {
  return (e7, o6) => "object" == typeof o6 ? r5(t6, e7, o6) : ((t7, e8, o7) => {
    const r7 = e8.hasOwnProperty(o7);
    return e8.constructor.createProperty(o7, t7), r7 ? Object.getOwnPropertyDescriptor(e8, o7) : void 0;
  })(t6, e7, o6);
}
...
// src/datatable/react.ts
var UwcDatatableReact = createComponent({
