...
var v2 = (o7, n6, e8) => {
  ...
  if (void 0 === e8) {
    ...
    if (t5 !== d3 || c5) {
      let o8 = e8._$AA;
      for (; o8 !== t5; ) {
        const t6 = i7(o8).nextSibling;
        i7(l3).insertBefore(o8, d3), o8 = t6;
      }
    }
  }
  return e8;
...
var UwcCarousel = class extends i4 {
  ...
  _onPointerMove(e8) {
    ...
    this._pointerDeltaX = e8.clientX - this._pointerStartX;
    this._pointerDeltaY = e8.clientY - this._pointerStartY;
  }
  _onPointerUp() {
    if (!this._dragging) return;
    this._dragging = false;
  ...
  _onKeyDown(e8) {
    ...
    switch (e8.key) {
      case "ArrowLeft":
      case "ArrowUp":
        if (isHoriz ? e8.key === "ArrowLeft" : e8.key === "ArrowUp") {
          e8.preventDefault();
          this._prev();
        }
        break;
      case "ArrowRight":
      case "ArrowDown":
        if (isHoriz ? e8.key === "ArrowRight" : e8.key === "ArrowDown") {
          e8.preventDefault();
          this._next();
        }
        break;
...
UwcCarousel.styles = styles_default;
__decorateClass([
  n4({ type: Array })
...
// src/carousel/react.ts
var UwcCarouselReact = createComponent({
  react: React,
