...
var y = class extends HTMLElement {
  ...
  requestUpdate(t4, s4, i6, e8 = false, h3) {
    if (void 0 !== t4) {
      ...
      if (false === e8 && (h3 = this[t4]), i6 ?? (i6 = r5.getPropertyOptions(t4)), !((i6.hasChanged ?? f)(h3, s4) || i6.useDefault && i6.reflect && h3 === this._$Ej?.get(t4) && !this.hasAttribute(r5._$Eu(t4, i6)))) return;
      this.C(t4, s4, i6);
    }
    false === this.isUpdatePending && (this._$ES = this._$EP());
  }
  C(t4, s4, { useDefault: i6, reflect: e8, wrapped: h3 }, r5) {
    i6 && !(this._$Ej ?? (this._$Ej = /* @__PURE__ */ new Map())).has(t4) && (this._$Ej.set(t4, r5 ?? s4 ?? this[t4]), true !== h3 || void 0 !== r5) || (this._$AL.has(t4) || (this.hasUpdated || i6 || (s4 = void 0), this._$AL.set(t4, s4)), true === e8 && this._$Em !== t4 && (this._$Eq ?? (this._$Eq = /* @__PURE__ */ new Set())).add(t4));
  }
  async _$EP() {
    ...
    for (; null !== (r5 = P.nextNode()) && d3.length < u3; ) {
      if (1 === r5.nodeType) {
        if (r5.hasAttributes()) for (const t5 of r5.getAttributeNames()) if (t5.endsWith(h2)) {
          const i7 = v2[a3++], s4 = r5.getAttribute(t5).split(o3), e9 = /([.?@])?(.*)/.exec(i7);
...
var H = class {
  ...
  _$AI(t4, i6 = this, s4, e8) {
    ...
    if (void 0 === h3) t4 = M(this, t4, i6, 0), o6 = !a2(t4) || t4 !== this._$AH && t4 !== E, o6 && (this._$AH = t4);
      ...
      const e9 = t4;
      let n5, r5;
      for (t4 = h3[0], n5 = 0; n5 < h3.length - 1; n5++) r5 = M(this, e9[s4 + n5], i6, n5), r5 === E && (r5 = this._$AH[n5]), o6 || (o6 = !a2(r5) || r5 !== this._$AH[n5]), r5 === A ? t4 = A : t4 !== A && (t4 += (r5 ?? "") + h3[n5 + 1]), this._$AH[n5] = r5;
    }
    o6 && !e8 && this.j(t4);
  }
  j(t4) {
...
var r4 = (t4 = o5, e8, r5) => {
  ...
  if (void 0 === s4 && globalThis.litPropertyMetadata.set(i6, s4 = /* @__PURE__ */ new Map()), "setter" === n5 && ((t4 = Object.create(t4)).wrapped = true), s4.set(r5.name, t4), "accessor" === n5) {
    ...
    return { set(r6) {
      ...
      e8.set.call(this, r6), this.requestUpdate(o6, n6, t4, true, r6);
    }, init(e9) {
  ...
  if ("setter" === n5) {
    ...
    return function(r6) {
      const n6 = this[o6];
      e8.call(this, r6), this.requestUpdate(o6, n6, t4, true, r6);
    };
  }
...
function n4(t4) {
  return (e8, o6) => "object" == typeof o6 ? r4(t4, e8, o6) : ((t5, e9, o7) => {
    const r5 = e9.hasOwnProperty(o7);
    return e9.constructor.createProperty(o7, t5), r5 ? Object.getOwnPropertyDescriptor(e9, o7) : void 0;
  })(t4, e8, o6);
}
...
function e5(e8, r5) {
  return (n5, s4, i6) => {
    ...
    if (r5) {
      const { get: e9, set: r6 } = "object" == typeof s4 ? n5 : i6 ?? /* @__PURE__ */ (() => {
...
var UwcAccordion = class extends i4 {
  ...
  _applyGrouped() {
    Array.from(this.children).filter((el) => el instanceof UwcAccordionPanel).forEach((p3) => {
      if (this.stacked) p3.setAttribute("grouped", "");
      else p3.removeAttribute("grouped");
    });
  }
  _applyActiveIndex() {
    if (!this.activeIndex) return;
    this.activeIndex.split(",").map((s4) => parseInt(s4.trim(), 10)).filter((n5) => !isNaN(n5)).forEach((i6) => {
      const p3 = this._panels[i6];
      if (p3 && !p3.disabled) p3.collapsed = false;
    });
  }
  // ── Event handlers ────────────────────────────────────────────────────────
  _onPanelConnect() {
  ...
  _onPanelToggle(e8) {
    const panel = e8.target;
    const index = this._panels.indexOf(panel);
    if (index === -1) return;
    e8.preventDefault();
    const wasCollapsed = panel.collapsed;
    if (!this.multiple) {
      this._panels.forEach((p3, i6) => {
        if (p3 !== panel && !p3.collapsed) {
          p3.collapsed = true;
          emit(this, "uwc-close", { index: i6, value: p3.value || String(i6) });
        }
      });
    }
    if (wasCollapsed) {
  ...
  openAll() {
    this._panels.forEach((p3, i6) => {
      if (!p3.disabled && p3.collapsed) {
        p3.collapsed = false;
        emit(this, "uwc-open", { index: i6, value: p3.value || String(i6) });
      }
    });
    this._emitChange();
  }
  ...
  getActiveIndices() {
    return this._panels.map((p3, i6) => p3.collapsed ? -1 : i6).filter((i6) => i6 >= 0);
  }
  // ── Render ────────────────────────────────────────────────────────────────
  render() {
...
// src/accordion/react.ts
var UwcAccordionReact = createComponent({
  react: React,
...
var UwcAccordionPanelReact = createComponent({
  react: React,
