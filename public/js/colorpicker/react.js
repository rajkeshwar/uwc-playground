...
var y = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t5, s4, i7) {
    const { get: e8, set: r5 } = h(this.prototype, t5) ?? { get() {
      return this[s4];
    }, set(t6) {
      this[s4] = t6;
    } };
  ...
  requestUpdate(t5, s4, i7, e8 = false, h3) {
    if (void 0 !== t5) {
      ...
      if (false === e8 && (h3 = this[t5]), i7 ?? (i7 = r5.getPropertyOptions(t5)), !((i7.hasChanged ?? f)(h3, s4) || i7.useDefault && i7.reflect && h3 === this._$Ej?.get(t5) && !this.hasAttribute(r5._$Eu(t5, i7)))) return;
      this.C(t5, s4, i7);
    }
    false === this.isUpdatePending && (this._$ES = this._$EP());
  }
  C(t5, s4, { useDefault: i7, reflect: e8, wrapped: h3 }, r5) {
    i7 && !(this._$Ej ?? (this._$Ej = /* @__PURE__ */ new Map())).has(t5) && (this._$Ej.set(t5, r5 ?? s4 ?? this[t5]), true !== h3 || void 0 !== r5) || (this._$AL.has(t5) || (this.hasUpdated || i7 || (s4 = void 0), this._$AL.set(t5, s4)), true === e8 && this._$Em !== t5 && (this._$Eq ?? (this._$Eq = /* @__PURE__ */ new Set())).add(t5));
  }
  async _$EP() {
...
var N = (t5, i7) => {
  ...
  return [V(t5, l3 + (t5[s4] || "<?>") + (2 === i7 ? "</svg>" : 3 === i7 ? "</math>" : "")), e8];
};
var S2 = class _S {
    ...
    for (; null !== (r5 = P.nextNode()) && d3.length < u3; ) {
      if (1 === r5.nodeType) {
        if (r5.hasAttributes()) for (const t6 of r5.getAttributeNames()) if (t6.endsWith(h2)) {
          const i8 = v2[a3++], s4 = r5.getAttribute(t6).split(o3), e9 = /([.?@])?(.*)/.exec(i8);
          d3.push({ type: 1, index: l3, name: e9[2], strings: s4, ctor: "." === e9[1] ? I : "?" === e9[1] ? L : "@" === e9[1] ? z : H }), r5.removeAttribute(t6);
...
function M(t5, i7, s4 = t5, e8) {
  ...
  return h3?.constructor !== o7 && (h3?._$AO?.(false), void 0 === o7 ? h3 = void 0 : (h3 = new o7(t5), h3._$AT(t5, s4, e8)), void 0 !== e8 ? (s4._$Co ?? (s4._$Co = []))[e8] = h3 : s4._$Cl = h3), void 0 !== h3 && (i7 = M(t5, h3._$AS(t5, i7.values), h3, e8)), i7;
}
var R = class {
  constructor(t5, i7) {
...
var H = class {
  ...
  _$AI(t5, i7 = this, s4, e8) {
    ...
    if (void 0 === h3) t5 = M(this, t5, i7, 0), o7 = !a2(t5) || t5 !== this._$AH && t5 !== E, o7 && (this._$AH = t5);
      ...
      const e9 = t5;
      let n6, r5;
      for (t5 = h3[0], n6 = 0; n6 < h3.length - 1; n6++) r5 = M(this, e9[s4 + n6], i7, n6), r5 === E && (r5 = this._$AH[n6]), o7 || (o7 = !a2(r5) || r5 !== this._$AH[n6]), r5 === A ? t5 = A : t5 !== A && (t5 += (r5 ?? "") + h3[n6 + 1]), this._$AH[n6] = r5;
    }
    o7 && !e8 && this.j(t5);
  }
  j(t5) {
...
var r4 = (t5 = o5, e8, r5) => {
  ...
  if (void 0 === s4 && globalThis.litPropertyMetadata.set(i7, s4 = /* @__PURE__ */ new Map()), "setter" === n6 && ((t5 = Object.create(t5)).wrapped = true), s4.set(r5.name, t5), "accessor" === n6) {
    ...
    return { set(r6) {
      ...
      e8.set.call(this, r6), this.requestUpdate(o7, n7, t5, true, r6);
    }, init(e9) {
  ...
  if ("setter" === n6) {
    ...
    return function(r6) {
      const n7 = this[o7];
      e8.call(this, r6), this.requestUpdate(o7, n7, t5, true, r6);
    };
  }
...
function n4(t5) {
  return (e8, o7) => "object" == typeof o7 ? r4(t5, e8, o7) : ((t6, e9, o8) => {
    ...
    return e9.constructor.createProperty(o8, t6), r5 ? Object.getOwnPropertyDescriptor(e9, o8) : void 0;
  })(t5, e8, o7);
}
  ...
  update(e8, [r5]) {
    ...
    for (const t5 in r5) {
      ...
      if (null != e9) {
        ...
        t5.includes("-") || r6 ? s4.setProperty(t5, r6 ? e9.slice(0, -11) : e9, r6 ? n5 : "") : s4[t5] = e9;
      }
    }
    return E;
  }
...
// src/colorpicker/react.ts
var UwcColorPickerReact = createComponent({
