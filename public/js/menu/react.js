...
var i = (t6, ...e8) => {
  const o7 = 1 === t6.length ? t6[0] : e8.reduce((e9, s5, o8) => e9 + ((t7) => {
...
var y = class extends HTMLElement {
  ...
  _$AK(t6, s5) {
    ...
    if (void 0 !== e8 && this._$Em !== e8) {
      const t7 = i8.getPropertyOptions(e8), h4 = "function" == typeof t7.converter ? { fromAttribute: t7.converter } : void 0 !== t7.converter?.fromAttribute ? t7.converter : u;
      this._$Em = e8;
      const r6 = h4.fromAttribute(s5, t7.type);
      this[e8] = r6 ?? this._$Ej?.get(e8) ?? r6, this._$Em = null;
    }
  }
  requestUpdate(t6, s5, i8, e8 = false, h4) {
    if (void 0 !== t6) {
      const r6 = this.constructor;
      if (false === e8 && (h4 = this[t6]), i8 ?? (i8 = r6.getPropertyOptions(t6)), !((i8.hasChanged ?? f)(h4, s5) || i8.useDefault && i8.reflect && h4 === this._$Ej?.get(t6) && !this.hasAttribute(r6._$Eu(t6, i8)))) return;
      this.C(t6, s5, i8);
    }
    false === this.isUpdatePending && (this._$ES = this._$EP());
  }
  C(t6, s5, { useDefault: i8, reflect: e8, wrapped: h4 }, r6) {
    i8 && !(this._$Ej ?? (this._$Ej = /* @__PURE__ */ new Map())).has(t6) && (this._$Ej.set(t6, r6 ?? s5 ?? this[t6]), true !== h4 || void 0 !== r6) || (this._$AL.has(t6) || (this.hasUpdated || i8 || (s5 = void 0), this._$AL.set(t6, s5)), true === e8 && this._$Em !== t6 && (this._$Eq ?? (this._$Eq = /* @__PURE__ */ new Set())).add(t6));
  }
  async _$EP() {
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (t7.size > 0) for (const [s6, i8] of t7) {
        const { wrapped: t8 } = i8, e8 = this[s6];
        true !== t8 || this._$AL.has(s6) || void 0 === e8 || this.C(s6, void 0, i8, e8);
      }
    }
    let t6 = false;
    const s5 = this._$AL;
...
var N = (t6, i8) => {
  ...
  return [V(t6, l3 + (t6[s5] || "<?>") + (2 === i8 ? "</svg>" : 3 === i8 ? "</math>" : "")), e8];
};
var S2 = class _S {
    ...
    for (; null !== (r6 = P.nextNode()) && d3.length < u5; ) {
      if (1 === r6.nodeType) {
        if (r6.hasAttributes()) for (const t7 of r6.getAttributeNames()) if (t7.endsWith(h2)) {
          const i9 = v3[a3++], s5 = r6.getAttribute(t7).split(o3), e9 = /([.?@])?(.*)/.exec(i9);
...
function M(t6, i8, s5 = t6, e8) {
  if (i8 === E) return i8;
  let h4 = void 0 !== e8 ? s5._$Co?.[e8] : s5._$Cl;
  const o7 = a2(i8) ? void 0 : i8._$litDirective$;
  return h4?.constructor !== o7 && (h4?._$AO?.(false), void 0 === o7 ? h4 = void 0 : (h4 = new o7(t6), h4._$AT(t6, s5, e8)), void 0 !== e8 ? (s5._$Co ?? (s5._$Co = []))[e8] = h4 : s5._$Cl = h4), void 0 !== h4 && (i8 = M(t6, h4._$AS(t6, i8.values), h4, e8)), i8;
}
var R = class {
  constructor(t6, i8) {
  ...
  u(t6) {
    const { el: { content: i8 }, parts: s5 } = this._$AD, e8 = (t6?.creationScope ?? l2).importNode(i8, true);
    P.currentNode = e8;
...
var k = class _k {
  ...
  constructor(t6, i8, s5, e8) {
    this.type = 2, this._$AH = A, this._$AN = void 0, this._$AA = t6, this._$AB = i8, this._$AM = s5, this.options = e8, this._$Cv = e8?.isConnected ?? true;
  }
  get parentNode() {
  ...
  $(t6) {
    const { values: i8, _$litType$: s5 } = t6, e8 = "number" == typeof s5 ? this._$AC(t6) : (void 0 === s5.el && (s5.el = S2.createElement(V(s5.h, s5.h[0]), this.options)), s5);
  ...
  k(t6) {
    ...
    const i8 = this._$AH;
    let s5, e8 = 0;
    for (const h4 of t6) e8 === i8.length ? i8.push(s5 = new _k(this.O(c3()), this.O(c3()), this, this.options)) : s5 = i8[e8], s5._$AI(h4), e8++;
...
var H = class {
  ...
  constructor(t6, i8, s5, e8, h4) {
    this.type = 1, this._$AH = A, this._$AN = void 0, this.element = t6, this.name = i8, this._$AM = e8, this.options = h4, s5.length > 2 || "" !== s5[0] || "" !== s5[1] ? (this._$AH = Array(s5.length - 1).fill(new String()), this.strings = s5) : this._$AH = A;
  }
  _$AI(t6, i8 = this, s5, e8) {
    const h4 = this.strings;
    let o7 = false;
    if (void 0 === h4) t6 = M(this, t6, i8, 0), o7 = !a2(t6) || t6 !== this._$AH && t6 !== E, o7 && (this._$AH = t6);
    else {
      const e9 = t6;
      let n6, r6;
      for (t6 = h4[0], n6 = 0; n6 < h4.length - 1; n6++) r6 = M(this, e9[s5 + n6], i8, n6), r6 === E && (r6 = this._$AH[n6]), o7 || (o7 = !a2(r6) || r6 !== this._$AH[n6]), r6 === A ? t6 = A : t6 !== A && (t6 += (r6 ?? "") + h4[n6 + 1]), this._$AH[n6] = r6;
    }
    o7 && !e8 && this.j(t6);
  }
  j(t6) {
...
var z = class extends H {
  constructor(t6, i8, s5, e8, h4) {
    super(t6, i8, s5, e8, h4), this.type = 5;
  }
  _$AI(t6, i8 = this) {
...
var D = (t6, i8, s5) => {
  ...
  if (void 0 === h4) {
    ...
    e8._$litPart$ = h4 = new k(i8.insertBefore(c3(), t7), t7, void 0, s5 ?? {});
  }
...
var r4 = (t6 = o5, e8, r6) => {
  ...
  if (void 0 === s5 && globalThis.litPropertyMetadata.set(i8, s5 = /* @__PURE__ */ new Map()), "setter" === n6 && ((t6 = Object.create(t6)).wrapped = true), s5.set(r6.name, t6), "accessor" === n6) {
    ...
    return { set(r7) {
      ...
      e8.set.call(this, r7), this.requestUpdate(o7, n7, t6, true, r7);
    }, init(e9) {
  ...
  if ("setter" === n6) {
    ...
    return function(r7) {
      const n7 = this[o7];
      e8.call(this, r7), this.requestUpdate(o7, n7, t6, true, r7);
    };
  }
...
var v2 = (o7, n6, e8) => {
  ...
  if (void 0 === e8) {
    ...
    const t6 = e8._$AB.nextSibling, n7 = e8._$AM, c5 = n7 !== o7;
    if (c5) {
      let t7;
      e8._$AQ?.(o7), e8._$AM = o7, void 0 !== e8._$AP && (t7 = o7._$AU) !== n7._$AU && e8._$AP(t7);
    }
    if (t6 !== d3 || c5) {
      let o8 = e8._$AA;
      for (; o8 !== t6; ) {
        const t7 = i6(o8).nextSibling;
        i6(l3).insertBefore(o8, d3), o8 = t7;
      }
    }
  }
  return e8;
};
var u3 = (o7, t6, i8 = o7) => (o7._$AI(t6, i8), o7);
var m2 = {};
...
var c4 = e6(class extends i5 {
  ...
  dt(e8, s5, t6) {
    ...
    const l3 = [], o7 = [];
    let i8 = 0;
    for (const s6 of e8) l3[i8] = r6 ? r6(s6, i8) : i8, o7[i8] = t6(s6, i8), i8++;
...
var o6 = e6(class extends i5 {
  ...
  render(t6) {
    return Object.keys(t6).reduce((e8, r6) => {
      const s5 = t6[r6];
  ...
  update(e8, [r6]) {
    ...
    for (const t6 in r6) {
      ...
      if (null != e9) {
        ...
        t6.includes("-") || r7 ? s5.setProperty(t6, r7 ? e9.slice(0, -11) : e9, r7 ? n5 : "") : s5[t6] = e9;
      }
    }
    return E;
  }
...
// src/menu/react.ts
var UwcMenuReact = createComponent({
  tagName: "uwc-menu",
